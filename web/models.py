...
class User(models.Model):
    ...
    intro = models.TextField(null=True, blank=True,
                             verbose_name="简介（支持html标签）")
    skill = models.TextField(null=True, blank=True,
                             verbose_name="技能（支持html标签）")


class Article(models.Model):
    """文章表"""
    author = models.ForeignKey(
        to="User", on_delete=models.CASCADE, verbose_name="作者")
...
class ArticleComments(models.Model):
    ...
    article = models.ForeignKey(
        to="Article", on_delete=models.CASCADE, verbose_name="文章")
...
class Album(models.Model):
    ...
    poster = models.ForeignKey(
        to="User", on_delete=models.CASCADE, verbose_name="发布者")
...
class Pictures(models.Model):
    ...
    album = models.ForeignKey(
        to="Album", on_delete=models.CASCADE, verbose_name="所属专题")
