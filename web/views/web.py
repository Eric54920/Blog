...
def home(request, *args, **kwargs):
    ...
    if sort_by:
        article = articles.filter(sort=request.GET.get('sort')).order_by('-create_time').values('pk', 'title', 'abstract', 'sort', 'tags', 'create_time')
    else:
        article = articles.order_by('-create_time').values('pk', 'title', 'abstract', 'sort', 'tags', 'create_time')
    ...
    result = {
        ...
        'sort': Counter(articles.values_list('sort')).items(),
